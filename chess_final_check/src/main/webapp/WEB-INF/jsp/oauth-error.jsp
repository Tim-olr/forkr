...
<%
    pageContext.setAttribute("pageTitle", "Sign-in Error");
%>
<!DOCTYPE html>
<html lang="en">
<head>
...
<div class="auth-wrap">
    <div class="auth-card">
        ...
        <h1 class="display" style="font-size:28px;margin:0 0 10px;color:var(--crimson)">Sign-in Failed</h1>
        <p style="color:var(--ink-mute);margin-bottom:24px;font-size:14px"><s:property value="callbackMessage"/></p>
